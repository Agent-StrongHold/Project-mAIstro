...
- **pydantic-ai-slim removed from the API and research images, clearing
  CVE-2026-25580 (HIGH).** ADR-094 already cut pydantic-ai from the codebase
  ...
  than bumped; anyio then resolves to 4.15.1 via starlette/httpx (no linked
  issue: caught by the required Supply chain (pip-audit) check; same reactive
  class as the anyio entry below).
