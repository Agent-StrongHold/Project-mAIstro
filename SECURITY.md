...
1. **SSRF protection is applied at the shared-client transport, not at call sites.**
   ...
   measured (`measured-outbound-http`), of the **31** modules in `maistro-core` that can open an
   ...
   shared pool. Measured (`measured-outbound-seam`) — **30** of the census route through the pool
