...
| Warden / Sentinel / Gate | `maistro.container`, `maistro_server` middleware | `10/53` | MIGRATE — construction is not enforcement | ADR-073, ADR-072, ADR-072726-0d6b | an E2E Conductor chat proving Warden/Sentinel ran on the real path | #66, #67, #68, #69, #70 |
