...
| Quota and billing | `routes.quotas`, `maistro.container` | `some` | MIGRATE — cost attaches to Invocation; #718 wired the recorder at Invocation terminalization, the explicit-verifier half stays unwired | ADR-085 | token/cost metadata on Invocation | #56, #63 |
