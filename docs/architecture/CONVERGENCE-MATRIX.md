...
|---|---|---|---|---|---|---|
| Run / NodeRun / Attempt lifecycle | reached via `maistro.graph.durable_runs` from `services.dag_agents` | `0/21` | KEEP — canonical | ADR-081226-a66b, ADR-081426-1f7c, ADR-081626-f383 | property/conformance tests in `formal/` plus core lifecycle suites | #42, #43, #45 |
