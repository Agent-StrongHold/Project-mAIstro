...
| Skills, code registry, repertoire | `routes.skills`, `services.mcp_client` | `most` | MIGRATE — one governed supply-chain path | ADR-069, ADR-070 | signed-code verification on real register/load path | #59, #34 |
