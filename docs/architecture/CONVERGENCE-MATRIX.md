...
| Tool execution | `services.tool_executor`, `maistro.container` | `8/25` | MIGRATE — tool calls must be governed Invocations | ADR-050, ADR-051, SPEC-252 | tool call produces Invocation + authorization + expected-effect evidence | #57, #59 |
...
| Warden / Sentinel / Gate | `maistro.container`, `maistro_server` middleware | `11/52` | MIGRATE — construction is not enforcement | ADR-073, ADR-072, ADR-072726-0d6b | an E2E Conductor chat proving Warden/Sentinel ran on the real path | #66, #67, #68, #69, #70 |
