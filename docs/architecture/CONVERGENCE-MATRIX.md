...
- `quality/ac-state-notes/` — per-branch AC-state bounds, folded rather than shared (#585). The measurement itself (`quality/ac-state.json`) is generated, not committed.
