...
| Conductor image (default) | CPython 3.13.15 plus the pinned wheel set | `operational` after crypto setup | Setup generates and vault-persists the seed, returns the one-time mnemonic, and records the DID |
