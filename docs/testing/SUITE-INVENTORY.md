...
|---|---:|---|
| `packages/maistro-core/tests` | 6490 | `ci.yml` |
...
<<<<<<< HEAD
| `tests/` (root) | 903 | `ci.yml` (minus `tests/tools/registry`, which `registry.yml` owns) |
=======
>>>>>>> origin/claude/issue-182-quota-session-migrations
