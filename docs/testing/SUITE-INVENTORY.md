...
|---|---:|---|
| `packages/maistro-core/tests` | 7095 | `ci.yml` |
| `packages/maistro-evolve/tests` | 629 | `ci.yml` |
| `packages/maistro-rsi/tests` | 428 | `ci.yml` |
| `packages/maistro-server/tests` | 203 | `ci.yml` |
...
| `tests/` (root) | 1035 | `ci.yml` (minus `tests/tools/registry`, which `registry.yml` owns) |
