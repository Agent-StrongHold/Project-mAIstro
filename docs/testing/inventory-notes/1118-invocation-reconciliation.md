...
and governed-context composition. They also verify that live dispatches cannot
be released by a premature not-applied resolution, that the configured container
selects the durable capability store, and that operator audit records retain actor,
reason, scope, and Run/NodeRun/Attempt/Invocation correlation.
