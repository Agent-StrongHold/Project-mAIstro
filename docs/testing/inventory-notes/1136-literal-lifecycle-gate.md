...
Fifteen test cases extend `tests/test_check_execution_lifecycles.py` for
status-shaped Literal aliases and field annotations, qualified and aliased
imports, PEP 604 and PEP 695 type-alias syntax, multiline values, bounded
name/value heuristics, enum values and annotated members, alias-wrapped fields,
