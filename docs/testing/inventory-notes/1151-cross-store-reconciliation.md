...
twelve behavioural tests, each parametrized over the memory, SQLite and PostgreSQL
continuation backends (12 × 3 = +36 node IDs; the PostgreSQL rows skip without
