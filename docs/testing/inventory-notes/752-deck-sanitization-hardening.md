...
obfuscation, active SVG/embedded-content families, re-sanitization of edited
DOM state, and cancellation of URI dragover/drop defaults. It runs against the
real Deck Builder component mounted by the ephemeral browser harness in preview
and presentation modes, and asserts that
