...
Thirty-five new node IDs across two files, both testing new gates in
...
## `test_check_workflow_write_safety.py` — the static guard (16)
...
## `test_check_gates_ran.py` — did the gates reach the commit (19)
