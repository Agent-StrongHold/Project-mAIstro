...
Adds `test_schedule_canonical_definitions.py` (#1199), 28 node IDs: 13
scenarios parametrised over the in-memory and SQLite `ScheduleStore` (26) and
...
after a disable or a delete, and the one-shot backfill. Nothing was removed
or moved.
