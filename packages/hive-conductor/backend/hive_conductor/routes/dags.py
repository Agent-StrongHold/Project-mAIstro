...
from hive_conductor.services.edit_lock import diff_dag_snapshots, mark_edited
...
async def run_dag(dag_id: str, request: Request) -> dict:
    ...
    from hive_conductor.services.graph_runner import CanonicalDagExecutionError, execute_dag
...
async def run_champion() -> dict:
    try:
        from hive_conductor.services.graph_runner import execute_champion
