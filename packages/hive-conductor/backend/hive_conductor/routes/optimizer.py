...
async def trigger_optimizer(
    ...
    if validate and result.get("proposals"):
        ...
        if dag_data:
            from hive_conductor.services.benchmark_eval import evaluate_dag_run
            from hive_conductor.services.graph_runner import execute_dag
            from hive_conductor.services.validation_gate import validate_and_filter_proposals
            ...
            from hive_conductor.services.validation_gate import hill_climb_models, hill_climb_params
