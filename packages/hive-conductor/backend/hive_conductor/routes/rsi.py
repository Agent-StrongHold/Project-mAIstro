...
from hive_conductor.services import rsi_execution_policy
...
@router.get("/status")
def rsi_status() -> dict:
    from hive_conductor.services.rsi import status
...
def list_runs() -> list[dict]:
    from hive_conductor.services.rsi import get_rsi_service
