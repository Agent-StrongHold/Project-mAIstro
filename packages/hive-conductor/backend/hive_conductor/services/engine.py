...
from hive_conductor.adapters.task_backend import TaskRecord
...
class EngineService:
    ...
    async def start(self, settings: Settings) -> None:
        from hive_conductor.adapters.maistro_core import MaistroCoreBridge, StubAgentPort
        ...
        from hive_conductor.services.node_metrics_store import reset_store
        ...
        from hive_conductor.services.dag_recovery import start_dag_recovery

        start_dag_recovery()

        try:
            if settings.hive_mode == "demo":
                from hive_conductor.adapters.task_backend import LocalTaskBackend
    ...
    async def stop(self) -> None:
        from hive_conductor.services.dag_recovery import stop_dag_recovery
