...
class _EvolutionService:
    ...
    async def _run_one_cycle(self, *, actor_principal_id: str | None = None) -> str:
        from hive_conductor.services.evolution_graph import run_canonical_evolution_cycle
    ...
    def _build_llm_call(self):
        try:
            ...
            from hive_conductor.services.secrets import litellm_api_key, maistro_llm_api_key
