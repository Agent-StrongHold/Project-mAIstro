...
class Foundation:
    ...
    def _init_state(self, settings: Settings, data_dir: Path) -> None:
        ...
        try:
            ...
            from hive_conductor.services.settings_store import PersistedSettingsRecordStore
            from hive_conductor.services.settings_store import configure as configure_settings
            ...
            from hive_conductor.services.dag_run_store import configure_dag_run_store

            configure_dag_run_store(stores.dag_runs)

            from hive_conductor.services.profile_store import PersistedProfileRecordStore
            from hive_conductor.services.profile_store import configure as configure_profiles
            ...
            from hive_conductor.services.registration_policy import PersistedRegistrationRecordStore
            from hive_conductor.services.registration_policy import (
                configure as configure_registration_policy,
            )
