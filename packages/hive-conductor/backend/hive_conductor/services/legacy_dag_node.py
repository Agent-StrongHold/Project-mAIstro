...
def _run_node_subprocess(
    ...
    from hive_conductor.services.hyperlight_executor import get_executor
...
async def _tool_web_search(
    ...
    from hive_conductor.services.tool_executor import web_search
...
async def _tool_clarify(tool_config: dict[str, Any], task_desc: str) -> str:
    from hive_conductor.services.tool_executor import clarify
...
async def _tool_browse_url(tool_config: dict[str, Any]) -> str:
    from hive_conductor.services.tool_executor import browse_url
...
async def _run_tool_node(
    ...
    try:
        from hive_conductor.services.tool_executor import TOOLS
