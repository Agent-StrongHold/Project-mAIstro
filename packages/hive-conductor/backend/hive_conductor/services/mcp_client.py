...
def resolve_atlassian_token(user_id: str | None) -> str | None:
    ...
    from hive_conductor.services.secrets import resolve_secret
        ...
        for provider in ("jira", "atlassian_rovo_mcp"):
            try:
                ...
                __import__("logging").getLogger("hive.services.mcp_client").warning(
                    ...
                    "packages/hive-conductor/backend/hive_conductor/services/mcp_client.py",
                    48,
                    _exc,
                )
                continue
...
async def test_mcp_server(
    ...
    *,
    ...
    from hive_conductor.services.mcp_defaults import ATLASSIAN_ROVO_SERVER_ID, is_atlassian_rovo_url
