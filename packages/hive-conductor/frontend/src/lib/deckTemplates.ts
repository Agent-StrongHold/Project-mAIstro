...
<div style="display:flex;align-items:center;gap:10px"><span style="width:12px;height:12px;border-radius:50%;background:#f59e0b"></span><span style="font-size:1rem;color:#e8e8f0;font-weight:600">Data Analysis</span><span style="margin-left:auto;font-size:1.1rem;font-weight:800;color:#f59e0b">14%</span></div>
</div></div>` },
