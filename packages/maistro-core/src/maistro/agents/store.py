...
logger = logging.getLogger("maistro.agents.store")

_NAME_PATTERN = re.compile(r"^[a-z][a-z0-9_-]{0,49}$")


class InMemoryAgentStore:
    """In-memory agent store with CRUD + GitAgent import/export."""
    ...
    async def import_gitagent(self, zip_data: bytes) -> str:
        ...
        identity = AgentIdentity(
            ...
            write_scopes=tuple(manifest.get("write_scopes", [])),
            trust_tier="t4",
