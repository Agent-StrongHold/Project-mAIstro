...
class TaskRecord(Base):
    ...
    # Originating and service identities are durable task receipt evidence;
    # they must survive queue persistence independently of the request body.
    user_id: Mapped[str] = mapped_column(String(200), nullable=False, default="")
    service_principal_id: Mapped[str | None] = mapped_column(String(200), nullable=True)
