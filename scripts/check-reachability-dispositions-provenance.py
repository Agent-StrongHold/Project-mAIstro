...
def main() -> int:
    ...
    # If a baseline addition is authorized, the mature candidate audit above
    # requires it to have a disposition. Spell that relationship explicitly in
    # the output so a missing row is diagnosed as the same debt transaction.
    failures.extend(
